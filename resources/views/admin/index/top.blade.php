...
@section('content')
    <h1>ダッシュボード</h1>
    <hr>
    <h2>{{ $monthly_achievement['month']->format('Y年n月')}}の月間実績</h2>
    ...
    <div class="uk-align-right">
        <a href="{{ route('admin.index.monthly') }}" class="uk-button uk-button-default uk-width-medium">全ての月間実績</a>
    </div>

    <h2>累計実績</h2>
    <div class="uk-grid-column-large uk-grid-row-large uk-child-width-1-4@s uk-text-center" uk-grid>
        <div>
            <div class="uk-card uk-card-default uk-card-body">
                <h3>店舗数</h3>
                <p class="uk-text-large">{{ $partners->count()}}</p>
            </div>
        </div>
        <div>
            <div class="uk-card uk-card-default uk-card-body">
                <h3>注文数</h3>
                <p class="uk-text-large">{{ $orders->count()}}</p>
            </div>
        </div>
        <div>
            <div class="uk-card uk-card-default uk-card-body">
                <h3>売上</h3>
                <p class="uk-text-large">{{ number_format($total_sales) }}</p>
            </div>
        </div>
        <div>
            <div class="uk-card uk-card-default uk-card-body">
                <h3>出荷袋数</h3>
                <p class="uk-text-large">{{ number_format($total_ship)}}</p>
            </div>
        </div>
    </div>
