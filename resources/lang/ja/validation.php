...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'registered' => '注文ステータス',
        'payment_status' => '請求ステータス',
        'payment_type' => '決済方法',
        'billing_date' => '請求日',
        'payment_due_date' => '入金日',
        'name' => '名前',
        'price' => '金額',
        'product_name' => '商品名',
        'arrival_date' => '到着日',
        ...
        'billing.name' => '請求先の宛名',
        'billing.post_code' => '請求先の郵便番号',
        'billing.prefecture' => '請求先の都道府県',
        'billling.address' => '請求先の住所',
        'billingg.address_detail' => '請求先の建物名',
        'billing.staff_name' => '請求先の担当者名',
        'status' => 'ステータス',
        'referral_count' => '紹介件数',
        'billing.id' => '請求先のID',
        'payjp_customer_token' => 'トークン',
    ],
